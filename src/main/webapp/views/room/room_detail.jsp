                ...
                <div class="card py-2 px-sm-4 px-3 shadow-sm">
                  <div class="card-body mx-n2">
                    ...
                    <div class="d-flex align-items-start mb-3 pb-0 border-bottom">
                      <div class="ps-2 ms-1">
                        <h3 class="h4 mb-2">${room.room_name } <i class="fi-star-filled mt-n1 me-1 text-warning align-middle opacity-70"></i><b>${room.room_rate} </b>(rate_cont)</h3>
          ...
          <section class="container mb-5 pb-1">
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <div class="d-flex align-items-start position-relative mb-4"><c:forTokens var="photo" items="${query[0].place_photo}" delims="," begin="0" end="0"><img class="flex-shrink-0 me-3 rounded-3" src="upload/${photo}" alt="Brand logo">
	              </c:forTokens><div>
                ...
                <!-- Item-->
                <div class="d-flex align-items-start position-relative mb-4"><c:forTokens var="photo" items="${query[1].place_photo}" delims="," begin="0" end="0"><img class="flex-shrink-0 me-3 rounded-3" src="<%=request.getContextPath()%>/upload/${photo}" alt="Brand logo">
                   </c:forTokens><div>
                ...
                <!-- Item -->
                <div class="d-flex align-items-start position-relative mb-4"><c:forTokens var="photo" items="${query[2].place_photo}" delims="," begin="0" end="0"><img class="flex-shrink-0 me-3 rounded-3" src="<%=request.getContextPath()%>/upload/${photo}" alt="Brand logo">
                  </c:forTokens><div>
              ...
              <div class="col-sm-6">
                <!-- Item -->
                <div class="d-flex align-items-start position-relative mb-4"><c:forTokens var="photo" items="${query[3].place_photo}" delims="," begin="0" end="0"><img class="flex-shrink-0 me-3 rounded-3" src="/upload/1654174102363cafe01.jpg" alt="Brand logo">
                  </c:forTokens><div>
                ...
                <!-- Item -->
                <div class="d-flex align-items-start position-relative mb-4"><c:forTokens var="photo" items="${query[4].place_photo}" delims="," begin="0" end="0"><img class="flex-shrink-0 me-3 rounded-3" src="<%=request.getContextPath()%>/upload/${photo}" alt="Brand logo">
                  </c:forTokens><div>
                ...
                <!-- Item -->
                <div class="d-flex align-items-start position-relative mb-4"><c:forTokens var="photo" items="${query[5].place_photo}" delims="," begin="0" end="0"><img class="flex-shrink-0 me-3 rounded-3" src="<%=request.getContextPath()%>/upload/${photo}" alt="Brand logo">
                 </c:forTokens><div>
